...
const theoryData = {
    ...
    <p style="font-size:0.9rem; color:#64748b;"><i>Πρακτική σημασία για διαμεσολαβητή:</i> Σε υποθέσεις όπου η διαφορά προκύπτει από παρωχημένη και όχι ουσιαστικά εσφαλμένη εγγραφή (π.χ. πρώτος αγοραστής δεν εμφανίζεται στο κτηματολόγιο αν και είχε νομίμως μεταγράψει), η §4 παρέχει εξωδικαστική οδό ρύθμισης.</p>
