...
const theoryData = {
    ...
    <h4>Άρθρο 18: Πρόδηλα Σφάλματα — Έννοια & Διόρθωση</h4>

    <div class="highlight-box" style="background:#eff6ff; border-left-color:#2563eb;">
        <b>📌 Τι είναι «πρόδηλο» σφάλμα;</b><br>
        Αόριστη νομική έννοια — χρήζει εξειδίκευσης <b>in concreto</b> κατά τρόπο <b>αντικειμενικό και ελέγξιμο</b>.<br>
        Η απαρίθμηση των περιπτώσεων στο νόμο είναι ευρεία αλλά <b>ενδεικτική</b>.<br>
        Το ρυθμιστικό πεδίο διευρύνθηκε με τους Ν. 3127/2003, 3481/2006 κ.λπ.
    </div>

    <div class="highlight-box" style="background:#fef3c7; border-left-color:#f59e0b; margin-top:12px;">
        <b>⚠️ Προσοχή — Αυτεπάγγελτη Διόρθωση:</b><br>
        Ο ΠρΚΓ <b>μπορεί να διορθώσει και αυτεπαγγέλτως</b> πρόδηλα σφάλματα (ιδίως ελλείψεις στοιχείων μεταγραφής).<br>
        Μπορεί όμως και να <b>σιωπήσει</b> σε μια αίτηση διόρθωσης που θα του υποβληθεί — δηλαδή δεν υποχρεούται να δεχθεί κάθε αίτηση ως «πρόδηλο».
    </div>

    <p style="margin-top:12px;">Διόρθωση πρόδηλου σφάλματος γίνεται από τον ΠρΚΓ <b>ατελώς</b>. Θεωρείται πρόδηλο σφάλμα (μεταξύ άλλων) όταν η ανακρίβεια:</p>
    <ul>
        <li><b>αα)</b> Προκύπτει από δημόσιο έγγραφο καταχωρισθέν στα υποθηκοφυλακεία</li>
        <li><b>ββ)</b> Προκύπτει από τη συσχέτιση εγγραφής με στοιχεία ανάρτησης</li>
        <li><b>γγ)</b> Προκύπτει από διοικητική πράξη ή απόφαση Επιτροπής Ενστάσεων</li>
        <li><b>δδ)</b> Αφορά σε ελλιπή ή ανακριβή στοιχεία οριζόντιων/κάθετων ιδιοκτησιών</li>
    </ul>
    <p><b>Απόφαση ΠρΚΓ υποχρεωτικά εντός 30 εργάσιμων ημερών.</b></p>
    ...
    <ul>
        <li><b>α) Μεταβιβάσεις:</b> Τα μη καταχωρισθέντα δικαιώματα μεταβιβάζονται και επιβαρύνονται κανονικά, αλλά απαιτείται ο μεταβιβάζων να έχει ασκήσει και καταχωρίσει στο κτηματολογικό φύλλο την αγωγή αμφισβήτησης. Η αγωγή αυτή αναπληρώνει την εγγραφή της πράξης μεταβίβασης ή σύστασης δικαιώματος. Η διόρθωση της ανακριβούς πρώτης εγγραφής γίνεται μόνο υπό τις προϋποθέσεις του άρθρου 7.</li>
        <li><b>β) Υποθήκες/Κατασχέσεις:</b> Για εγγραφή υποθήκης, προσημείωσης ή κατάσχεσης επί μη καταχωρισθέντος δικαιώματος απαιτείται η υποβολή τελεσίδικων αποφάσεων διάρρηξης καταδολιευτικών πράξεων κατά του ανακριβώς εγγεγραμμένου.</li>
        <li><b>γ) Υφιστάμενα βάρη:</b> Αν καταχωρισμένο δικαίωμα έχει νομίμως επιβαρυνθεί πριν τις πρώτες εγγραφές, κάθε πράξη που στηρίζεται σε αυτό μπορεί να διενεργηθεί υπό την προϋπόθεση προηγούμενης καταχώρισης της σχετικής εξουσίας διάθεσης.</li>
    </ul>

    <h4>Άρθρο 7β — Τύχη Δικαιωμάτων & Βαρών σε Εκκρεμή Αίτηση Διόρθωσης</h4>
    <p>Σε περίπτωση που έχει σημειωθεί στην πρώτη εγγραφή εκκρεμότητα εξέτασης αίτησης διόρθωσης (άρθρο 6Α ν. 2308/1995):</p>
    <ul>
        <li>Οι μεταβιβάσεις, συστάσεις και επιβαρύνσεις του ακινήτου είναι δυνατές σύμφωνα με τις οικείες διατάξεις, αλλά <b>τελούν υπό αναβλητική αίρεση</b> της καταχώρισης του μεταβιβάζοντος ή βεβαρημένου ως δικαιούχου.</li>
        <li>Το ίδιο ισχύει αναλόγως για κάθε μεταγενέστερη πράξη.</li>
        <li>Ο ΠρΚΓ κατά τον έλεγχο νομιμότητας διενεργεί σχετικό έλεγχο.</li>
    </ul>

    <h4>Άρθρο 8 — Μεταγενέστερες Εγγραφές έως Οριστικοποίηση Πρώτης</h4>
    <p>Κατά το χρόνο που οι πρώτες εγγραφές δεν έχουν ακόμη οριστικοποιηθεί (εκκρεμεί αμφισβήτηση), οι μεταγενέστερες εγγραφές στηρίζονται σε <b>μαχητό τεκμήριο</b> ακρίβειας της πρώτης εγγραφής. Το τεκμήριο αυτό δεν αντιτάσσεται κατά εκείνου που αμφισβήτησε την ακρίβεια της πρώτης εγγραφής — εκτός αν πρόκειται για εγγραφή που αφορά σε πρωτότυπο τρόπο κτήσης ή κατά τα οριζόμενα στο άρθρο 7α.</p>

    <h4>Άρθρο 9 — Ακίνητα που Περιέρχονται στο Δημόσιο</h4>
    <p>Ακίνητα που δεν έχουν εγγραφεί ως ανήκοντα σε ορισμένο πρόσωπο και φέρονται στα κτηματολογικά βιβλία ως «αγνώστου ιδιοκτήτη», μετά την <b>οριστικοποίηση των πρώτων εγγραφών</b> περιέρχονται στο Ελληνικό Δημόσιο και δημιουργείται υπέρ του αμάχητο τεκμήριο κυριότητας (κατ' άρθρο 7§1). Τα αρμόδια Κτηματολογικά Γραφεία μεριμνούν για τη σημείωση στα κτηματολογικά βιβλία της περιέλευσης στο Δημόσιο.</p>

    <h4>Άρθρο 12 — Εγγραπτέες Πράξεις (Αναλυτικά)</h4>
    <p>Στα κτηματολογικά φύλλα καταχωρίζονται:</p>
    <ul>
        <li><b>α-γ)</b> Πράξεις σύστασης, μεταβίβασης, αλλοίωσης ή κατάργησης εμπράγματων δικαιωμάτων (άρθρο 1192 ΑΚ) — συμπ. μεταλλειοκτησία, παραχωρήσεις Δημοσίου</li>
        <li><b>δ)</b> Δουλείες (άρθρο 1192 αρ. 3 ΑΚ)</li>
        <li><b>ε)</b> Υποθήκες και προσημειώσεις (αρ. 4 ΑΚ)</li>
        <li><b>στ)</b> Κατασχέσεις και δεσμεύσεις εξουσίας διάθεσης φερόμενου δικαιούχου (αρ. 5 ΑΚ)</li>
        <li><b>ζ)</b> Αποδοχές κληρονομιάς/κληροδοσίας (άρθρο 1193 ΑΚ)</li>
        <li><b>η)</b> Τίτλοι που παρέχουν δικαίωμα εγγραφής υποθήκης</li>
        <li><b>θ)</b> Εκχωρήσεις και ενεχυριάσεις ασφαλισμένης απαίτησης (άρθρο 1312 ΑΚ)</li>
        <li><b>ι)</b> Κατασχέσεις ακινήτων (άρθρο 992 ΚΠολΔ) και κάθε δέσμευση εξουσίας διάθεσης</li>
        <li><b>ιβ)</b> Αγωγές και αιτήσεις (άρθρο 220 ΚΠολΔ) — συμπ. <b>πρακτικά διαμεσολάβησης</b> (άρθρο 6§2δ)</li>
        <li><b>ιγ)</b> Μακροχρόνιες μισθώσεις (άρθρα 618 και 1208 ΑΚ)</li>
        <li><b>ιδ)</b> Χρονομεριστικές μισθώσεις (ν. 1652/1986)</li>
        <li><b>ιε)</b> Χρηματοδοτικές μισθώσεις (leasing)</li>
        <li><b>ιστ)</b> Κάθε άλλη δικαιοπραξία, δικαστική απόφαση ή διοικητική πράξη εγγραπτέα στα βιβλία μεταγραφών/υποθηκών</li>
    </ul>
    <p><b>Χωρίς εγγραφή</b> δεν επέρχεται το επιδιωκόμενο έννομο αποτέλεσμα στις περιπτώσεις α-η (εκτός θ). Η παράλειψη στις ι, ιβ, ιγ, ιδ δεν επάγεται ακυρότητα αλλά μη αντιτασσιμότητα κατά τρίτων.</p>

    <h4>Άρθρο 13Α — Εμβαδόν & Αποδεκτή Απόκλιση</h4>
    <p>Το καταχωρισθέν στο Κτηματολόγιο εμβαδόν <b>μόνο του δεν αποτελεί προσδιοριστικό στοιχείο</b> των ορίων του ακινήτου. Εντός της «<b>αποδεκτής απόκλισης</b>» (ποσοστό που καθορίζεται με απόφαση ανάλογα με τη μέθοδο αποτύπωσης), το κτηματολογικό διάγραμμα θεωρείται συμβατό ως προς σχήμα και όρια με τους μεταγραφέντες τίτλους. Εντός της «<b>ζώνης κανονισμού ορίων</b>» αποτυπώνεται το κοινό όριο γεωτεμαχίων.</p>
    <p>Εάν το εμβαδόν πράξης αποκλίνει εντός αποδεκτής απόκλισης από το καταχωρισθέν, ο ΠρΚΓ μπορεί να καταχωρίσει απευθείας χωρίς προηγούμενη διόρθωση.</p>

    <h4>Άρθρο 19§1 — Διόρθωση Γενικών Σφαλμάτων</h4>
    <p>Ο ΠρΚΓ, ύστερα από αίτηση οποιουδήποτε έχει έννομο συμφέρον, μπορεί να διορθώσει εγγραφές που δεν εμπίπτουν στο πρόδηλο σφάλμα του άρθρου 18, κατά τη διαδικασία του άρθρου 782 ΚΠολΔ (εκούσια δικαιοδοσία).</p>

    <h4>Άρθρο 19§2 — Διόρθωση Γεωμετρικών Στοιχείων</h4>
    <div class="highlight-box" style="background:#f0fdf4; border-left-color:#059669;">
        <b>✅ Δεν υπόκειται σε προθεσμία</b> (ρητά ορίζεται στον νόμο)<br>
        Διενεργείται κατόπιν αιτήσεως οποιουδήποτε έχει έννομο συμφέρον — ατελώς.<br>
        Αφορά τόσο αρχικές όσο και μεταγενέστερες εγγραφές (ΑΠ 1632/2011).<br>
        Σωρεύεται με αίτηση άρθρου 18 αν απαιτείται.<br>
        <b>→ Αναλυτικά: βλ. ξεχωριστό entry «Άρθρο 19§2 — Διόρθωση Γεωμετρικών Στοιχείων»</b>
    </div>

    <h4>Άρθρο 19§3 — Αναδασμός</h4>
    <p>Αν υφίσταται εγγραφή στα κτηματολογικά φύλλα απόφασης κύρωσης αναδασμού, ο ΠρΚΓ προβαίνει στην εγγραφή <b>αυτεπαγγέλτως ή κατόπιν αιτήσεως</b>.</p>

    <h4>Άρθρο 19§4 — Σφάλματα σε Περιοχές χωρίς Κυρωμένο Δασικό Χάρτη</h4>
    <p>Αν σε περιοχές για τις οποίες δεν υφίσταται κυρωμένο ρυμοτομικό ή πολεοδομικό σχέδιο, ο ΠρΚΓ προβαίνει στη διόρθωση της σχετικής κτηματολογικής εγγραφής σύμφωνα με τα ισχύοντα.</p>

    <h4>Άρθρο 19§5 — Εγγραφή Δημοσίου & Δασικός Χάρτης</h4>
    <p>Αν για το ακίνητο σωρευτικά: α) υφίσταται εγγραφή με εμφαινόμενο ιδιοκτήτη το Ελληνικό Δημόσιο, β) υφίσταται απόφαση ΕπΕνστ/Επ.Εξ.Αντ. με την οποία έγινε δεκτή αντίρρηση κατά του δασικού χάρτη ή βρίσκεται σε εξαιρούμενη περιοχή ή υφίσταται παραχωρητήριο κ.λπ., γ) προκύπτει εμπράγματο δικαίωμα φυσικού/νομικού προσώπου, και δ) η εγγραφή ερείδεται αποκλειστικά στο τεκμήριο κυριότητας Δημοσίου επί δασών — ο ΠρΚΓ προβαίνει αυτεπαγγέλτως στη διόρθωση.</p>

    <h4>Άρθρο 19Α — Επαναπροσδιορισμός Θέσης Ακινήτων</h4>
    <p>Με απόφαση του Φορέα «Ελληνικό Κτηματολόγιο» κηρύσσεται περιοχή σε <b>καθεστώς επαναπροσδιορισμού</b> της αποτύπωσης των ακινήτων στα κτηματολογικά διαγράμματα — όταν εφαρμόζονται νεότερες τεχνικές προδιαγραφές. Η απόφαση δημοσιεύεται στο ΦΕΚ.</p>
    <ul>
        <li>Κατά τη διάρκεια εργασιών αναστέλλεται η εφαρμογή του άρθρου 13Α στην περιοχή</li>
        <li>Αναστέλλεται επίσης η προθεσμία του άρθρου 6§2 για αγωγή αμφισβήτησης</li>
        <li>Κάθε επηρεαζόμενος δικαιούχος μπορεί ψηφιακά να επιβεβαιώσει ή καταχωρίσει ηλεκτρονική διεύθυνση για ενημερώσεις</li>
        <li>Μετά την αναμόρφωση, νέα τοπογραφικά με βάση τον νέο ΚΑΕΚ είναι αναγκαία για μεταγενέστερες πράξεις</li>
    </ul>

    <h4>Άρθρο 23 — Μετάβαση από Υποθηκοφυλακεία στο Κτηματολόγιο</h4>
    <ul>
        <li>Από την έναρξη ισχύος του Κτηματολογίου τα Υποθηκοφυλακεία <b>παύουν να δέχονται εγγραφές</b> για τα κτηματογραφηθέντα ακίνητα</li>
        <li>Τα βιβλία των Υποθηκοφυλακείων <b>φυλάσσονται</b> από το Υποθηκοφυλακείο, που εκδίδει και τα σχετικά αντίγραφα/πιστοποιητικά</li>
        <li>Αν κτηματογραφηθεί τμήμα μόνο της περιοχής → παράλληλη λειτουργία Υποθηκοφυλακείου και ΚΓ</li>
        <li><b>Μεταβατική λειτουργία:</b> Τα Υποθηκοφυλακεία (έμμισθα ή άμισθα) λειτουργούν ως ΚΓ μέχρι τη σύσταση αυτοτελούς ΚΓ</li>
        <li>Οι υποθηκοφύλακες που δεν διορίζονται ΠρΚΓ τοποθετούνται σε άλλες θέσεις ή μετατάσσονται</li>
        <li><b>6 μήνες πριν</b> από την έναρξη λειτουργίας του ΚΓ: προπαρασκευαστικές ενέργειες στέγασης και εκπαίδευσης προσωπικού</li>
    </ul>`,
