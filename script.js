...
const theoryData = {
    ...
    <div class="moore-circle">
        <div class="moore-node" style="border-left-color: #be185d;">
            <h4>Βήμα 5: BATNA & ZOPA (Reality Testing)</h4>
            <p><b>Reality Testing:</b> Η προσγείωση στην πραγματικότητα του δικαστηρίου και ο έλεγχος των ορίων. Η τέχνη είναι να ενεργοποιήσουμε ελεγχόμενα το φόβο της απώλειας.</p>
            <ul>
                <li>Ποιο είναι το χειρότερο σενάριο (BATNA) αν δεν βρούμε λύση σήμερα και καταλήξετε στο δικαστήριο;</li>
                <li>Πόσο χρόνο και χρήμα είστε πραγματικά διατεθειμένοι να ξοδέψετε σε δικαστικά έξοδα τα επόμενα 3 χρόνια;</li>
                <li>Ποια είναι η εναλλακτική σας (Plan B) αν η άλλη πλευρά αποχωρήσει τώρα από το τραπέζι;</li>
                <li>Έχετε συνυπολογίσει την ψυχολογική φθορά και το άγχος μιας μακροχρόνιας δικαστικής διαμάχης;</li>
                <li>Αν το δικαστήριο απορρίψει την αγωγή σας, πώς θα διαχειριστείτε επιχειρηματικά την επόμενη μέρα;</li>
                <li>Ποιο είναι το απόλυτο "όριο" (ZOPA) κάτω (ή πάνω) από το οποίο δεν σας συμφέρει πλέον να κλείσετε συμφωνία;</li>
            </ul>
        </div>
    </div>`,
