...
const theoryData = {
    ...
    harvard_model: `<h3>Η Μεθοδολογία του Harvard (Principled Negotiation) - Βήμα προς Βήμα</h3>
    <p>Το μοντέλο διαπραγμάτευσης του Harvard (Harvard Negotiation Project), που αναπτύχθηκε από τους Roger Fisher και William Ury στο βιβλίο "Getting to Yes", αποτελεί τον ακρογωνιαίο λίθο της σύγχρονης διαμεσολάβησης. Ακολουθεί η αναλυτική μεθοδολογία εφαρμογής του σε 5 διακριτά βήματα:</p>

    <div class="highlight-box" style="border-left-color: #be185d; background: #fff1f2;">
        <h4 style="margin-top:0; color: #be185d;">Βήμα 1: Διαχωρισμός των Ανθρώπων από το Πρόβλημα</h4>
        <p><b>Στόχος:</b> Η αποφόρτιση της έντασης και η δημιουργία συνεργατικού κλίματος.</p>
        <ul>
            <li><b>Ενσυναίσθηση & Αναγνώριση:</b> Επιτρέψτε στα μέρη να εκφράσουν τα συναισθήματά τους (θυμός, φόβος, απογοήτευση) χωρίς να τα κρίνετε.</li>
            <li><b>Αποφυγή Επίρριψης Ευθυνών:</b> Κατευθύνετε τη συζήτηση μακριά από το "ποιος φταίει" (παρελθόν) στο "πώς λύνεται" (μέλλον).</li>
            <li><b>Ενεργητική Ακρόαση:</b> "Μαλακοί με τους ανθρώπους, σκληροί με το πρόβλημα". Κατανοήστε την οπτική τους γωνία.</li>
        </ul>
    </div>

    <div class="highlight-box" style="border-left-color: #be185d; background: #fff1f2;">
        <h4 style="margin-top:0; color: #be185d;">Βήμα 2: Εστίαση στα Συμφέροντα (Interests), όχι στις Θέσεις (Positions)</h4>
        <p><b>Στόχος:</b> Η αποκάλυψη των πραγματικών αναγκών πίσω από τις άκαμπτες απαιτήσεις.</p>
        <ul>
            <li><b>Η Θέση (Αυτό που λένε):</b> Π.χ. "Θέλω 50.000 ευρώ αποζημίωση τώρα και δεν κάνω πίσω."</li>
            <li><b>Το Συμφέρον (Αυτό που χρειάζονται):</b> Π.χ. "Χρειάζομαι άμεσα ρευστότητα για να σώσω την επιχείρησή μου."</li>
            <li><b>Δράση Διαμεσολαβητή:</b> Κάντε διερευνητικές ερωτήσεις "Γιατί το ζητάτε αυτό;" και "Γιατί απορρίπτετε την άλλη πρόταση;" για να σκάψετε κάτω από την επιφάνεια.</li>
        </ul>
    </div>

    <div class="highlight-box" style="border-left-color: #be185d; background: #fff1f2;">
        <h4 style="margin-top:0; color: #be185d;">Βήμα 3: Παραγωγή Επιλογών για Αμοιβαίο Όφελος (Brainstorming)</h4>
        <p><b>Στόχος:</b> Η "μεγέθυνση της πίτας" πριν τον τελικό διαμοιρασμό της (Win-Win).</p>
        <ul>
            <li><b>Διαχωρισμός Εφεύρεσης από Απόφαση:</b> Προτρέψτε τα μέρη (ειδικά στις κατ' ιδίαν συναντήσεις) να ρίξουν ελεύθερα ιδέες στο τραπέζι, χωρίς να δεσμεύονται ότι θα τις αποδεχτούν.</li>
            <li><b>Αναζήτηση Αμοιβαίου Κέρδους:</b> Βρείτε λύσεις όπου το κόστος για τη μία πλευρά είναι μικρό, αλλά η αξία για την άλλη πλευρά είναι τεράστια (ανταλλαγή παραχωρήσεων).</li>
        </ul>
    </div>

    <div class="highlight-box" style="border-left-color: #be185d; background: #fff1f2;">
        <h4 style="margin-top:0; color: #be185d;">Βήμα 4: Χρήση Αντικειμενικών Κριτηρίων</h4>
        <p><b>Στόχος:</b> Η συμφωνία να βασίζεται σε λογική, όχι σε πείσμα ή εκβιασμούς.</p>
        <ul>
            <li><b>Ανεξάρτητα Πρότυπα:</b> Αντί να μαλώνουν για το ποιανού η γνώμη είναι σωστή, βασίστε τη λύση σε εξωτερικά, μετρήσιμα δεδομένα: αγοραία αξία, νόμος, πραγματογνωμοσύνη, επαγγελματικά στάνταρ, δεδικασμένο.</li>
            <li><b>Δίκαιη Διαδικασία:</b> Εάν δεν μπορούν να συμφωνήσουν στην ουσία της διαφοράς, προσπαθήστε να τους κάνετε να συμφωνήσουν σε μια δίκαιη διαδικασία (π.χ. ας ορίσουμε από κοινού έναν ανεξάρτητο εκτιμητή).</li>
        </ul>
    </div>

    <div class="moore-circle">
        <div class="moore-node" style="border-left-color: #be185d;">
            <h4>Βήμα 5α: Καθορισμός BATNA (Έλεγχος Ισχύος)</h4>
            <p><b>Best Alternative To a Negotiated Agreement:</b> Είναι η καλύτερη εναλλακτική λύση που έχει ένα μέρος αν οι διαπραγματεύσεις καταρρεύσουν. Στη διαμεσολάβηση, το BATNA είναι συνήθως το Δικαστήριο. Ο ρόλος σας είναι μέσω Reality Testing να τους βοηθήσετε να υπολογίσουν ρεαλιστικά το χρόνο, τα δικαστικά έξοδα, τη φθορά και το ρίσκο απόρριψης της αγωγής.</p>
        </div>
        <div class="moore-node" style="border-left-color: #be185d;">
            <h4>Βήμα 5β: Εντοπισμός του ZOPA</h4>
            <p><b>Zone of Possible Agreement:</b> Είναι η "Ζώνη Πιθανής Συμφωνίας". Είναι το εύρος στο οποίο επικαλύπτονται οι ανοχές των δύο πλευρών. (π.χ. Ο Α είναι διατεθειμένος να δώσει μέχρι 10.000€ και ο Β δέχεται να λάβει από 8.000€ και πάνω. Το ZOPA είναι 8.000€ - 10.000€). Η τέχνη σας είναι να τους οδηγήσετε σε αυτή τη ζώνη.</p>
        </div>
    </div>`,
