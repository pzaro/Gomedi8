...
const theoryData = {
    ...
    <ul>
        ...
        <li><b>Μεταβιβάσεις πριν πρώτες εγγραφές (§4):</b> Πράξεις που έχουν καταχωριστεί στο υποθηκοφυλακείο μεταφέρονται με αίτηση στο κτηματολόγιο — ατελώς και χωρίς πρόσθετα τέλη.</li>
    ...
    </div>`, `<h3>🏠 Ν. 2308/1995 — Κτηματογράφηση & Εθνικό Κτηματολόγιο</h3>
