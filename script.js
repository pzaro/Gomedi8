...
const theoryData = {
    ...
    <p>Το μοντέλο διαπραγμάτευσης του Harvard (Harvard Negotiation Project), που αναπτύχθηκε από τους Roger Fisher και William Ury, αποκτά άλλη διάσταση όταν κατανοήσουμε πώς οι ερωτήσεις του Διαμεσολαβητή "καλωδιώνουν" τον εγκέφαλο των μερών. Ακολουθεί η αντιστοίχιση βημάτων, ερωτήσεων και νευρολογικών αντιδράσεων:</p>
    ...
    <div class="highlight-box" style="border-left-color: #be185d; background: #fff1f2;">
        ...
        <p><b>Το Ερώτημα:</b> <i>"Πώς σας έκανε να νιώσετε αυτή η κατάσταση; Τι σας πλήγωσε περισσότερο;"</i></p>
        <ul>
            <li><b>Αντίδραση:</b> Συναισθηματική Αποφόρτιση (Venting) και Επικύρωση.</li>
            <li><b>Ο Εγκέφαλος:</b> Το ερώτημα αυτό βοηθά τον <b>Κοιλιοέσω Προμετωπιαίο Φλοιό (vmPFC)</b> (υπεύθυνο για τη συναισθηματική ρύθμιση) να "κατευνάσει" την <b>Αμυγδαλή</b> (το κέντρο συναγερμού/φόβου/θυμού). Όταν το μέρος νιώσει ότι ακούστηκε, η αμυντικότητα (fight-or-flight) πέφτει.</li>
        </ul>
    </div>

    <div class="highlight-box" style="border-left-color: #be185d; background: #fff1f2;">
        <h4 style="margin-top:0; color: #be185d;">Βήμα 2: Εστίαση στα Συμφέροντα (Interests), όχι στις Θέσεις</h4>
        <p><b>Το Ερώτημα:</b> <i>"Πέρα από το ποσό των 50.000€ που ζητάτε (Θέση), τι είναι αυτό που πραγματικά έχετε ανάγκη να πετύχετε αύριο το πρωί (Συμφέρον);"</i></p>
        <ul>
            <li><b>Αντίδραση:</b> Ενδοσκόπηση και Μετατόπιση Οπτικής.</li>
            <li><b>Ο Εγκέφαλος:</b> Μεταφέρει την ενέργεια και τη ροή του αίματος από το μεταιχμιακό (συναισθηματικό) σύστημα στον <b>Ραχιοπλάγιο Προμετωπιαίο Φλοιό (dlPFC)</b>. Αυτή η περιοχή είναι η "CPU" του εγκεφάλου, υπεύθυνη για τη λογική ανάλυση, τον σχεδιασμό και την ευέλικτη γνωστική επεξεργασία.</li>
        </ul>
    </div>

    <div class="highlight-box" style="border-left-color: #be185d; background: #fff1f2;">
        <h4 style="margin-top:0; color: #be185d;">Βήμα 3: Παραγωγή Επιλογών (Options) - Brainstorming</h4>
        <p><b>Το Ερώτημα:</b> <i>"Αν είχαμε ένα μαγικό ραβδί, ποιες άλλες εναλλακτικές λύσεις θα μπορούσαμε να σκεφτούμε για να καλυφθούν και οι δύο πλευρές;"</i></p>
        <ul>
            <li><b>Αντίδραση:</b> Δημιουργικότητα (Win-Win) χωρίς δέσμευση.</li>
            <li><b>Ο Εγκέφαλος:</b> Ενεργοποιεί το <b>Δίκτυο Προεπιλεγμένης Λειτουργίας (DMN - Default Mode Network)</b>. Το DMN ενεργοποιείται όταν φανταζόμαστε το μέλλον, επιτρέποντας τη δημιουργική σκέψη (out-of-the-box). Παράλληλα εκκρίνεται ντοπαμίνη (επιβράβευση) κατά την παραγωγή νέων ιδεών.</li>
        </ul>
    </div>

    <div class="highlight-box" style="border-left-color: #be185d; background: #fff1f2;">
        <h4 style="margin-top:0; color: #be185d;">Βήμα 4: Αντικειμενικά Κριτήρια</h4>
        <p><b>Το Ερώτημα:</b> <i>"Με βάση ποια αντικειμενικά δεδομένα της αγοράς (π.χ. πραγματογνωμοσύνη, νόμος, πρακτική) προκύπτει αυτός ο αριθμός;"</i></p>
        <ul>
            <li><b>Αντίδραση:</b> Εκλογίκευση και Δίκαιη Διαδικασία.</li>
            <li><b>Ο Εγκέφαλος:</b> Ο Προμετωπιαίος Φλοιός κάνει αυστηρή λογική αξιολόγηση. Εμπλέκεται ο <b>Πρόσθιος Φλοιός του Προσαγωγίου (ACC)</b>, ο οποίος ανιχνεύει σφάλματα, παρακολουθεί τη σύγκρουση και αξιολογεί το αίσθημα της "Δικαιοσύνης" της τελικής απόφασης.</li>
        </ul>
    </div>

    <div class="moore-circle">
        <div class="moore-node" style="border-left-color: #be185d;">
            <h4>Βήμα 5α: Καθορισμός BATNA</h4>
            <p><b>Best Alternative To a Negotiated Agreement:</b> Η καλύτερη εναλλακτική λύση αν οι διαπραγματεύσεις καταρρεύσουν. Ο ρόλος σας είναι μέσω Reality Testing να τους βοηθήσετε να υπολογίσουν ρεαλιστικά το χρόνο, τα δικαστικά έξοδα και το ρίσκο του Δικαστηρίου (ενεργοποίηση της αμυγδαλής ελεγχόμενα μέσω του φόβου της απώλειας).</p>
        </div>
        <div class="moore-node" style="border-left-color: #be185d;">
            <h4>Βήμα 5β: Εντοπισμός του ZOPA</h4>
            <p><b>Zone of Possible Agreement:</b> Το εύρος στο οποίο επικαλύπτονται οι ανοχές των δύο πλευρών. Η τέχνη σας είναι να τους οδηγήσετε σε αυτή τη ζώνη, επιβεβαιώνοντας στον εγκέφαλο τους (έκκριση ωκυτοκίνης) το αίσθημα της ασφάλειας και της συνεργασίας.</p>
        </div>
    </div>`,
