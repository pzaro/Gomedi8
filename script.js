...
// Αρχικοποίηση με κενά πεδία (για να εμφανίζεται το προειδοποιητικό μήνυμα αν δεν γίνει αναζήτηση)
let m_data = {
...
<div style="border: 1.5pt solid #2563eb; padding: 15pt; margin: 20pt auto; background-color: #f0f7ff; width: 100%; box-sizing: border-box; text-align: center; border-radius: 8pt;">
    ...
    // Δυναμικές μεταβλητές Διαμεσολαβητή με προειδοποιητικό μήνυμα αν δεν έχει γίνει αναζήτηση
    const warningMsg = "<span style='color: red;'>[Καταχωρίστε ΑΜΔ διαμεσολαβητή για να ενημερωθούν τα πεδία]</span>";
